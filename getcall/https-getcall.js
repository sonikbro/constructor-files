...
var GC_CONFIG = {
        ...
        css: "https://forstas.bizconstructor.com/tilda-assets/src/getcall/style.css"
    },
    GETCALLHTML = '<div class="getcall__wrapper"><div class="getcall__inner"><div class="getcall__header"><div class="getcall__button" data-show="false" ><div><img src="https://forstas.bizconstructor.com/tilda-assets/src/getcall/phone.svg" alt=""></div><span></span></div><div class="getcall__hover" data-show="false"><span>Закажите звонок</span><span>или напишите нам сообщение</span></div></div><div class="getcall__content"></div></div></div>',
    GETCALL = {
        init: function () {
...
$(".getcall__content").after('<div class="ta"> <a href="https://m.me/business.constructor" target="_blank"><img src="https://forstas.bizconstructor.com/tilda-assets/src/getcall/fb.svg" alt=""></a> <a href="https://t.me/romatheawesome" target="_blank"><img src="https://forstas.bizconstructor.com/tilda-assets/src/getcall/tg.svg" alt=""></a> <a href="viber://chat?number=0685280583" target="_blank"><img src="https://forstas.bizconstructor.com/tilda-assets/src/getcall/vb.svg" alt=""></a> <a href="mailto:r.sagan@bizconstructor.com" target="_blank"><img src="https://forstas.bizconstructor.com/tilda-assets/src/getcall/email.svg" alt=""></a></div>'), $(".getcall__header").click(function () {
