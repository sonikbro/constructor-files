...
function initMask() {
    ...
    new Inputmask("+38 099 999 99 99", {
        ...
        keypressEvent: function (t, e, a, i, o) {
            ...
            if (!(!0 === e || t.ctrlKey && t.altKey) && (t.ctrlKey || t.metaKey || ignorable)) return s === Inputmask.keyCode.ENTER && undoValue !== getBuffer().join("") && (undoValue = getBuffer().join(""), setTimeout((function () {
                n.trigger("change")
            }), 0)), !0;
            if (s) {
                46 === s && !1 === t.shiftKey && "" !== opts.radixPoint && (s = opts.radixPoint.charCodeAt(0));
                var l, c = e ? {
                        begin: o,
                        end: o
                    } : caret(r),
                ...
                var u = isValid(c, _, i);
                if (!1 !== u && (resetMaskSet(!0), l = void 0 !== u.caret ? u.caret : e ? u.pos + 1 : seekNext(u.pos), getMaskSet().p = l), !1 !== a) {
                    var p = this;
                    if (setTimeout((function () {
                            opts.onKeyValidation.call(p, s, u, opts)
                        }), 0), getMaskSet().writeOutBuffer && !1 !== u) {
                        var g = getBuffer();
                        writeBuffer(r, g, opts.numericInput && void 0 === u.caret ? seekPrevious(l) : l, t, !0 !== e), !0 !== e && setTimeout((function () {
                ...
                if (t.preventDefault(), e) return u.forwardPosition = l, u
            }
        }
    }).mask(t)
}
