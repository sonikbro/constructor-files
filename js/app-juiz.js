...
var newInputs = '<input type="hidden" name="rolecompany" value="" autocomplete="off"><input type="hidden" name="countcompany" value="" autocomplete="off">';
...
function createRadios(index) {
    ...
    var answerKey = questions[index].key;
...
function choose() {
    ...
    var currentQuestion = $('input[name="answer"]:checked').attr('answerkey'),
